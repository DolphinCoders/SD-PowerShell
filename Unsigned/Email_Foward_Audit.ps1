# Source https://gcits.com/knowledge-base/find-inbox-rules-forward-mail-externally-office-365-powershell/
# This script runs using delegated admin credentials across all client tenants
